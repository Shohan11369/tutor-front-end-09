...
import { authClient } from '@/lib/auth-client'; // authClient ব্যবহার করা উত্তম
...
export default function Login() {
    ...
    return (
        <div className="min-h-[80vh] flex flex-col bg-slate-50 items-center justify-center p-4">
                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-slate-200 shadow-2xl space-y-8 relative overflow-hidden">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex justify-end">
                            <Link href="#" className="text-sm font-bold text-blue-600 hover:underline underline-offset-4 transition-all">
                                Forgot password?
                            </Link>
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            <Image width={20} height={20} src="https://www.google.com/favicon.ico" className="w-5 h-5" alt="Google" />
                            Sign in with Google
                        </Button>
                    </div>
